...
; (function ($) {
    ...
    var retinaLogos = function() {
        var retina = window.devicePixelRatio > 1 ? true : false;
          if(retina) {
              $('.logo-header').find('img').attr( {src:'images/home/irvinglogo.png',width:'102.7',height:'59.96'} );
              $('.logo-footer-style2').find('img').attr( {src:'images/home/irvinglogo.png',width:'102.7',height:'59.96'} );
              $('.logo-footer').find('img').attr( {src:'images/home/light-logo.png',width:'142.7',height:'59.96'} );  
          }
      };       
