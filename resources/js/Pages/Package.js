...
export default function Packages(props) {
    ...
    const columns = [
        ...
        { field: 'period', headerName: 'Period', width: 200, type: 'string' },
        { 
            field: 'price', 
            headerName: 'Price', 
            width: 100, 
    ...
    const CreateItem = async (data) => {
        ...
        setUpdating(true)
        const response = await fetch(API_BASE_URL + "/packages", requestOptions)
    ...
    return (
        <Authenticated
            auth={props.auth}
            errors={props.errors}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Irving Landscape | Packages</h2>}
        >
            <Head title="Packages" />
            ...
            <div className='py-12'>
                <form className="max-w-7xl mx-auto sm:px-6 lg:px-8 text-lg">
                    <h2 className='text-2xl font-bold'>Create a new Package</h2>
                    ...
                    <div className='w-full flex flex-col my-4'>
                        ...
                        <input id="period" name="period" className='py-3 px-2 focus:ring-0 focus:outline-none rounded-sm' placeholder="Package Period" value={formPeriod} onChange={(e)=>{
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 bg-white border-b border-gray-200">Packages</div>
                        <DataTable data={packages ? packages : []}/>
                    </div>
                </div>
            </div>
        </Authenticated>
