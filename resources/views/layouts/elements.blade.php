...
<head>
    ...
    <title>Irving's Lawn & Gardens | Premium Landscaping Website </title>
    <meta name="keywords" content="Premium Landscaping, Lawn, Garden, Mowing, Grass, Roses, flowers, london, belleville, Irvings Landscaping, Irvings">
                            ...
                            <div class="footer-info-item">
                                <div class="location">
                                    ...
                                    <div class="content-location">
                                        <div class="heading-16px-rubik">8 Centre St, Belleville ON K8N 4W5
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="footer-info-item">
                                <div class="phone-call">
                                    ...
                                    <div class="content-phone-call">
                                        <div class="heading-16px-rubik">+1 (630) 970-2255</div>
                                    </div>
                                </div>
                            </div>
                            <div class="footer-info-items">
                                <div class="email">
                                    ...
                                    <div class="content-email">
                                        <div class="heading-16px-rubik">info@irvingslandscaping.ca</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="list-footer wow fadeInUp">
                    <div class="footer-item">
                        <div class="widgets-about padding-top-listfooter">
                            ...
                            <p class="text-decs">
                                Irving's Landscaping is a company that engages in state of the art lawn maintenance and installati, <a href ="about.php">MORE...</a>
                            </p>
                    ...
                    <div class="footer-item padding-top-listfooter">
                        <div class="widgets-subcribes">
                            ...
                            <div class="widgets-input-subcribes">
                                <form id="subscribe_form" method="post" class="form-subcribe">
                ...
                <div class="col-md-12">
                    <div class="copyright link-style4">
                        <p class="copyright-text">
                            Powered By <a href="www.hoffenheimtechnologies.com">Hoffenheim Technologies</a> &copy; <script>document.write(new Date().getFullYear())</script> All Rights Reserved</p>
                        </p>
                    </div>
